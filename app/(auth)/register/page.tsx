  ...
  return (
    <div style={{minHeight:'100vh', background:'#f9fafb', display:'flex', alignItems:'center', justifyContent:'center'}}>
      <div style={{background:'white', border:'1px solid #f3f4f6', borderRadius:'16px', padding:'40px', width:'100%', maxWidth:'400px'}}>
        ...
        <p style={{margin:'0 0 32px', fontSize:'13px', color:'#9ca3af', textAlign:'center'}}>
        ...
        <div style={{display:'flex', flexDirection:'column', gap:'16px'}}>
          <div>
            <label style={{display:'block', fontSize:'12px', fontWeight:500, color:'#374151', marginBottom:'6px'}}>Nombre completo</label>
            <input
              type="text"
        ...
        <p style={{margin:'24px 0 0', fontSize:'13px', color:'#9ca3af', textAlign:'center'}}>
          ¿Ya tienes cuenta?{' '}
          <a href="/login" style={{color:'#2563eb', textDecoration:'none', fontWeight:500}}>Inicia sesión</a>
        </p>
